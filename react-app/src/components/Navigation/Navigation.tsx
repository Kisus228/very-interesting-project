...
const Navigation = () => {
    ...
    return (
        <ul className={classes.Navigation}>
            <li>
                <NavLink to={'/liked'} className={url === '/liked' ? classes.active : undefined}>
            ...
            <li>
                <NavLink to={'/'} className={url === '/' ? classes.active : undefined}>
            ...
            <li>
                <NavLink to={'/123'} className={url === '/123' ? classes.active : undefined}>
