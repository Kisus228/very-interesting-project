...
export const Edit = (props: { onClick: () => void }) => {
    return (
        <svg className={classes.Clickable} onClick={props.onClick} width="19" height="19" viewBox="0 0 19 19" fill="none">
...
export const Close = (props: { onClick: () => void }) => {
    return (
        <svg className={classes.Clickable} onClick={props.onClick} width="14" height="14" viewBox="0 0 14 14" fill="none">
...
export const Open = (props: { onClick: () => void }) => {
    return (
        <svg className={classes.Clickable} onClick={props.onClick} width="18" height="18" viewBox="0 0 18 18" fill="none">
            <path fillRule="evenodd" clipRule="evenodd"
...
export const Delete = (props: { onClick: () => void }) => {
    return (
        <svg className={classes.Clickable} onClick={props.onClick} width="14" height="18" viewBox="0 0 14 18" fill="none">
            <path fillRule="evenodd" clipRule="evenodd"
