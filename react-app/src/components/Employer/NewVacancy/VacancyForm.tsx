                    ...
                    <Form>
                        ...
                        <div className={classes.NewVacancy}>
                            <section className={classes.VacancySection}>
                                ...
                                <FormTextarea label={"Описание вакансии"} name="vacancyDescription"
                                ...
                                <FormTextarea label={"Условия"} name="conditions"
                            ...
                            <section className={classes.VacancySection}>
                                <FormSelect name={"skills"} label={"Навыки"} defaultValue={props.initialValues.skills}
                                            ...
                                            required/>
                                <FormTextarea label={"Требования"} name="requirements"
                                              placeholder={"Напишите требования вакансии"} required/>
                                <FormTextarea label={"Обязанности"} name="responsibilities"
                                ...
                                <FormTextarea label={"Дополнительно"} name="additionally"
